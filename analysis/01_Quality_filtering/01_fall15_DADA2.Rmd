...
```{r}
#set the path 
raw_fastqs_path <- "data/fastq_data/fastq_files"
...
Solution: We will use stricter expected error rates because of the reverse read , then truncLen = c(250,217) to eliminate the sudden abrupt dips in quality.
...
postQC_aggregate_plot
```
[The random dips in quality below 20 have been eliminated while maintaining good sequencing depth, the dip at the end of the reverse read has been eliminated as well.
...
```
[Most of the sequences were maintained and general distribution of the sequences across samples was also maintained]
