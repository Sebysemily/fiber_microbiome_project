...
```{r load-data}
load("data/04_Phylogenetic_Tree/phytree_preprocessed_physeq.RData")

# take a look at it! 
archaea_root_physeq

# Intuition check on seq depth
min(sample_sums(archaea_root_physeq))
...
ggiNEXT(iNEXT_data, type = 1, facet.var = "Order.q") + 
  ...
  scale_shape_manual(values = base::rep(17, nsamples(archaea_root_physeq))) + 
  theme_bw() + 
